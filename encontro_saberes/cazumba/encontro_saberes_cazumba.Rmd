...
Nesta seção, incluímos somente as quatro espécies que apresentaram taxa de encontro anual média > 0.04 ind/km, o que equivale a um mínimo de um encontro a cada 25 km percorridos: quatipuru, cutia, caititu e cutiara (Tabela 3).
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 2. Taxa de encontro anual para cutia na RESEX Cazumbá-Iracema, 2014-2021"}
plot_tendencia_Dasyprocta_fuliginosa

```

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 2. Taxa de encontro anual para cutiara na RESEX Cazumbá-Iracema, 2014-2021"}
plot_tendencia_Myoprocta_pratti

```

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 2. Taxa de encontro anual para caititu na RESEX Cazumbá-Iracema, 2014-2021"}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 3. Taxa de encontro anual para quatipuru por trilha na RESEX Cazumbá-Iracema, 2014-2021"}
plot_tendencia_trilha_Sciuridae

```


```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 3. Taxa de encontro anual para cutia por trilha na RESEX Cazumbá-Iracema, 2014-2021"}
plot_tendencia_trilha_Dasyprocta_fuliginosa

```


```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 3. Taxa de encontro anual para cutiara por trilha na RESEX Cazumbá-Iracema, 2014-2021"}
plot_tendencia_trilha_Myoprocta_pratti

```


```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 3. Taxa de encontro anual para caititu por trilha na RESEX Cazumbá-Iracema, 2014-2021"}
