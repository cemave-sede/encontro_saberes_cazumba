...
tabela_1 <- jamari %>%
  ...
  mutate(nome_popular = ifelse(especie == "Cabassous unicinctus", "Tatu-de-rabo-mole",
                        ...
                        ifelse(especie == "Mico rondoni", "Mico-da-cara-preta",
...
A tabela 2 apresenta o número total de encontros e de indivíduos avistados por espécie. As espécies mais encontradas foram, nessa ordem: cutia, macaco-prego, macaco-aranha, soim e mico-da-cara-preta. A maioria das outras espécies foram encontradas poucas (< 10) vezes. Para as espécies que vivem em grupos, o número indivíduos pode ser maior do que o número de encontros.
...
Somente quatro espécies apresentaram taxa de encontro anual média > 0.04 ind/km, o que equivale aproximadamente a um encontro a cada 25 km percorridos (Tabela 3): cutia, macaco-prego, macaco-aranha e soim. As Figuras 2 a 5 mostram como as taxas de avistamento variaram para estas espécies ao longo do monitoramento.
...
computar.plotar.taxa_encontro("Ateles chamek")
computar.plotar.taxa_encontro("Saguinus weddelli")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 3. Taxa de encontro anual para macaco-prego na FLONA do Jamari, 2014-2021"}
plot_tendencia_Sapajus_apella

```


```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 4. Taxa de encontro anual para macaco-aranha na FLONA do Jamari, 2014-2021"}
plot_tendencia_Ateles_chamek

```


```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 5. Taxa de encontro anual para soim na FLONA do Jamari, 2014-2021"}
plot_tendencia_Saguinus_weddelli
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 6. Taxa de encontro anual para cutia por trilha na FLONA do Jamari, 2014-2021"}
plot_tendencia_trilha_Dasyprocta_fuliginosa

```


```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 7. Taxa de encontro anual para macaco-prego por trilha na FLONA do Jamari, 2014-2021"}
plot_tendencia_trilha_Sapajus_apella

```


```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 8. Taxa de encontro anual para macaco-aranha por trilha na FLONA do Jamari, 2014-2021"}
plot_tendencia_trilha_Ateles_chamek

```


```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figura 9. Taxa de encontro anual para soim por trilha na FLONA do Jamari, 2014-2021"}
plot_tendencia_trilha_Saguinus_weddelli
...
As espécies mais comuns encontradas no monitoramento foram cutia, macaco-prego, macaco-aranha, soim e mico-da-cara-preta. Isso está de acordo com a percepção da comunidade?
